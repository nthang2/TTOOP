...
import AimsProject.src.hust.soict.aims.exception.PlayerException;
...
public class Aims {
	...
	public static void main(String[] args) throws Exception {
		...
		DigitalVideoDisc dvd3 = new DigitalVideoDisc("Aladin", "Animation", 23.4f);
		Track track1 = new Track("Track1", 42);
		Track track2 = new Track("Track2", 16);
		CompactDisc cd1 = new CompactDisc("Allstars", "hero", "Alibaaba", "Someone", 343.2f);
		cd1.addTrack(track1);
		cd1.addTrack(track2);
		Book book1 = new Book("Sherlock Holmes", "Detective", 420, 412f);
